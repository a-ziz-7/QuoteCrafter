...
exports.VizierServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/vizier_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./vizier_service_client_config.json");
...
class VizierServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listStudies: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'studies'),
            listTrials: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'trials'),
        };
        ...
        const suggestTrialsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.SuggestTrialsResponse');
        const suggestTrialsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.SuggestTrialsMetadata');
        const checkTrialEarlyStoppingStateResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CheckTrialEarlyStoppingStateResponse');
        const checkTrialEarlyStoppingStateMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CheckTrialEarlyStoppingStateMetatdata');
        this.descriptors.longrunning = {
            suggestTrials: new this._gaxModule.LongrunningDescriptor(this.operationsClient, suggestTrialsResponse.decode.bind(suggestTrialsResponse), suggestTrialsMetadata.decode.bind(suggestTrialsMetadata)),
            checkTrialEarlyStoppingState: new this._gaxModule.LongrunningDescriptor(this.operationsClient, checkTrialEarlyStoppingStateResponse.decode.bind(checkTrialEarlyStoppingStateResponse), checkTrialEarlyStoppingStateMetadata.decode.bind(checkTrialEarlyStoppingStateMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.VizierService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.vizierServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.VizierService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.VizierService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of vizierServiceStubMethods) {
            const callPromise = this.vizierServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createStudy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    getStudy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    deleteStudy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    lookupStudy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createTrial(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getTrial(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    addTrialMeasurement(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                trial_name: (_a = request.trialName) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.addTrialMeasurement(request, options, callback);
    }
    completeTrial(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    deleteTrial(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    stopTrial(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listOptimalTrials(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    suggestTrials(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkSuggestTrialsProgress(name) {
    ...
    checkTrialEarlyStoppingState(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.checkTrialEarlyStoppingState(request, options, callback);
    }
    /**
     ...
     */
    async checkCheckTrialEarlyStoppingStateProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listStudies(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listStudiesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listStudies.createStream(this.innerApiCalls.listStudies, request, callSettings);
    }
    /**
    ...
    listStudiesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listStudies.asyncIterate(this.innerApiCalls['listStudies'], request, callSettings);
    }
    listTrials(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listTrialsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTrials.createStream(this.innerApiCalls.listTrials, request, callSettings);
    }
    /**
    ...
    listTrialsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTrials.asyncIterate(this.innerApiCalls['listTrials'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=vizier_service_client.js.map