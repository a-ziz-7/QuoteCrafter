...
exports.ScheduleServiceClient = void 0;
 ...
 */
const gapicConfig = require("./schedule_service_client_config.json");
...
class ScheduleServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listSchedules: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'schedules'),
        };
        ...
        const deleteScheduleResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteScheduleMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            deleteSchedule: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteScheduleResponse.decode.bind(deleteScheduleResponse), deleteScheduleMetadata.decode.bind(deleteScheduleMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.ScheduleService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.scheduleServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.ScheduleService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.ScheduleService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of scheduleServiceStubMethods) {
            const callPromise = this.scheduleServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createSchedule(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    getSchedule(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    pauseSchedule(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    resumeSchedule(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateSchedule(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'schedule.name': (_a = request.schedule.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateSchedule(request, options, callback);
    }
    deleteSchedule(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteScheduleProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteSchedule, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    listSchedules(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     *   {@link protos.google.cloud.aiplatform.v1.ListSchedulesResponse.next_page_token|ListSchedulesResponse.next_page_token}
     *   of the previous
     *   {@link protos.google.cloud.aiplatform.v1.ScheduleService.ListSchedules|ScheduleService.ListSchedules}
     *   call.
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1.Schedule|Schedule} on 'data' event.
    ...
    listSchedulesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listSchedules.createStream(this.innerApiCalls.listSchedules, request, callSettings);
    }
    /**
     ...
     *   {@link protos.google.cloud.aiplatform.v1.Schedule|Schedule}. The API will be called under the hood as needed, once per the page,
    ...
    listSchedulesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listSchedules.asyncIterate(this.innerApiCalls['listSchedules'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=schedule_service_client.js.map