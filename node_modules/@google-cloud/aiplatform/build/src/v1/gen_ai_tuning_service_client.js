...
exports.GenAiTuningServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/gen_ai_tuning_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./gen_ai_tuning_service_client_config.json");
...
class GenAiTuningServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listTuningJobs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'tuningJobs'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.GenAiTuningService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.genAiTuningServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.GenAiTuningService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.GenAiTuningService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of genAiTuningServiceStubMethods) {
            const callPromise = this.genAiTuningServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createTuningJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    getTuningJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    cancelTuningJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listTuningJobs(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    listTuningJobsStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.listTuningJobs.createStream(this.innerApiCalls.listTuningJobs, request, callSettings);
    }
    /**
     ...
     */
    listTuningJobsAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTuningJobs.asyncIterate(this.innerApiCalls['listTuningJobs'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=gen_ai_tuning_service_client.js.map