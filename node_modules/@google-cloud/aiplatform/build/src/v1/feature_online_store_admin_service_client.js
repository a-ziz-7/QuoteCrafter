...
exports.FeatureOnlineStoreAdminServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/feature_online_store_admin_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./feature_online_store_admin_service_client_config.json");
...
class FeatureOnlineStoreAdminServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listFeatureOnlineStores: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'featureOnlineStores'),
            listFeatureViews: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'featureViews'),
            listFeatureViewSyncs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'featureViewSyncs'),
        };
        ...
        const createFeatureOnlineStoreResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.FeatureOnlineStore');
        const createFeatureOnlineStoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateFeatureOnlineStoreOperationMetadata');
        const updateFeatureOnlineStoreResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.FeatureOnlineStore');
        const updateFeatureOnlineStoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdateFeatureOnlineStoreOperationMetadata');
        const deleteFeatureOnlineStoreResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteFeatureOnlineStoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const createFeatureViewResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.FeatureView');
        const createFeatureViewMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateFeatureViewOperationMetadata');
        const updateFeatureViewResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.FeatureView');
        const updateFeatureViewMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdateFeatureViewOperationMetadata');
        const deleteFeatureViewResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteFeatureViewMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            createFeatureOnlineStore: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createFeatureOnlineStoreResponse.decode.bind(createFeatureOnlineStoreResponse), createFeatureOnlineStoreMetadata.decode.bind(createFeatureOnlineStoreMetadata)),
            updateFeatureOnlineStore: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateFeatureOnlineStoreResponse.decode.bind(updateFeatureOnlineStoreResponse), updateFeatureOnlineStoreMetadata.decode.bind(updateFeatureOnlineStoreMetadata)),
            deleteFeatureOnlineStore: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteFeatureOnlineStoreResponse.decode.bind(deleteFeatureOnlineStoreResponse), deleteFeatureOnlineStoreMetadata.decode.bind(deleteFeatureOnlineStoreMetadata)),
            createFeatureView: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createFeatureViewResponse.decode.bind(createFeatureViewResponse), createFeatureViewMetadata.decode.bind(createFeatureViewMetadata)),
            updateFeatureView: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateFeatureViewResponse.decode.bind(updateFeatureViewResponse), updateFeatureViewMetadata.decode.bind(updateFeatureViewMetadata)),
            deleteFeatureView: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteFeatureViewResponse.decode.bind(deleteFeatureViewResponse), deleteFeatureViewMetadata.decode.bind(deleteFeatureViewMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.FeatureOnlineStoreAdminService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.featureOnlineStoreAdminServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.FeatureOnlineStoreAdminService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1
                    .FeatureOnlineStoreAdminService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of featureOnlineStoreAdminServiceStubMethods) {
            const callPromise = this.featureOnlineStoreAdminServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getFeatureOnlineStore(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    getFeatureView(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    syncFeatureView(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                feature_view: (_a = request.featureView) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.syncFeatureView(request, options, callback);
    }
    getFeatureViewSync(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createFeatureOnlineStore(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.createFeatureOnlineStore(request, options, callback);
    }
    /**
     ...
     */
    async checkCreateFeatureOnlineStoreProgress(name) {
    ...
    updateFeatureOnlineStore(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'feature_online_store.name': (_a = request.featureOnlineStore.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateFeatureOnlineStore(request, options, callback);
    }
    /**
     ...
     */
    async checkUpdateFeatureOnlineStoreProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deleteFeatureOnlineStore(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.deleteFeatureOnlineStore(request, options, callback);
    }
    /**
     ...
     */
    async checkDeleteFeatureOnlineStoreProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    createFeatureView(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateFeatureViewProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    updateFeatureView(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'feature_view.name': (_a = request.featureView.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     */
    async checkUpdateFeatureViewProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deleteFeatureView(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteFeatureViewProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listFeatureOnlineStores(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.listFeatureOnlineStores(request, options, callback);
    }
    /**
    ...
    listFeatureOnlineStoresStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listFeatureOnlineStores.createStream(this.innerApiCalls.listFeatureOnlineStores, request, callSettings);
    }
    /**
    ...
    listFeatureOnlineStoresAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listFeatureOnlineStores.asyncIterate(this.innerApiCalls['listFeatureOnlineStores'], request, callSettings);
    }
    listFeatureViews(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listFeatureViewsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listFeatureViews.createStream(this.innerApiCalls.listFeatureViews, request, callSettings);
    }
    /**
    ...
    listFeatureViewsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listFeatureViews.asyncIterate(this.innerApiCalls['listFeatureViews'], request, callSettings);
    }
    listFeatureViewSyncs(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listFeatureViewSyncsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listFeatureViewSyncs.createStream(this.innerApiCalls.listFeatureViewSyncs, request, callSettings);
    }
    /**
    ...
    listFeatureViewSyncsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listFeatureViewSyncs.asyncIterate(this.innerApiCalls['listFeatureViewSyncs'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=feature_online_store_admin_service_client.js.map