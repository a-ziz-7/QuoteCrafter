...
exports.TensorboardServiceClient = void 0;
 ...
 */
const gapicConfig = require("./tensorboard_service_client_config.json");
...
class TensorboardServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listTensorboards: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'tensorboards'),
            listTensorboardExperiments: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'tensorboardExperiments'),
            listTensorboardRuns: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'tensorboardRuns'),
            listTensorboardTimeSeries: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'tensorboardTimeSeries'),
            exportTensorboardTimeSeriesData: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'timeSeriesDataPoints'),
        };
        // Some of the methods on this service provide streaming responses.
        // Provide descriptors for these.
        this.descriptors.stream = {
            readTensorboardBlobData: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.SERVER_STREAMING, !!opts.fallback, !!opts.gaxServerStreamingRetries),
        };
        ...
        const createTensorboardResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.Tensorboard');
        const createTensorboardMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateTensorboardOperationMetadata');
        const updateTensorboardResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.Tensorboard');
        const updateTensorboardMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdateTensorboardOperationMetadata');
        const deleteTensorboardResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteTensorboardMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const deleteTensorboardExperimentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteTensorboardExperimentMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const deleteTensorboardRunResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteTensorboardRunMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const deleteTensorboardTimeSeriesResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteTensorboardTimeSeriesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            createTensorboard: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createTensorboardResponse.decode.bind(createTensorboardResponse), createTensorboardMetadata.decode.bind(createTensorboardMetadata)),
            updateTensorboard: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateTensorboardResponse.decode.bind(updateTensorboardResponse), updateTensorboardMetadata.decode.bind(updateTensorboardMetadata)),
            deleteTensorboard: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteTensorboardResponse.decode.bind(deleteTensorboardResponse), deleteTensorboardMetadata.decode.bind(deleteTensorboardMetadata)),
            deleteTensorboardExperiment: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteTensorboardExperimentResponse.decode.bind(deleteTensorboardExperimentResponse), deleteTensorboardExperimentMetadata.decode.bind(deleteTensorboardExperimentMetadata)),
            deleteTensorboardRun: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteTensorboardRunResponse.decode.bind(deleteTensorboardRunResponse), deleteTensorboardRunMetadata.decode.bind(deleteTensorboardRunMetadata)),
            deleteTensorboardTimeSeries: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteTensorboardTimeSeriesResponse.decode.bind(deleteTensorboardTimeSeriesResponse), deleteTensorboardTimeSeriesMetadata.decode.bind(deleteTensorboardTimeSeriesMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.TensorboardService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.tensorboardServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.TensorboardService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.TensorboardService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of tensorboardServiceStubMethods) {
            const callPromise = this.tensorboardServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getTensorboard(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    readTensorboardUsage(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                tensorboard: (_a = request.tensorboard) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.readTensorboardUsage(request, options, callback);
    }
    readTensorboardSize(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createTensorboardExperiment(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.createTensorboardExperiment(request, options, callback);
    }
    getTensorboardExperiment(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.getTensorboardExperiment(request, options, callback);
    }
    updateTensorboardExperiment(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'tensorboard_experiment.name': (_a = request.tensorboardExperiment.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateTensorboardExperiment(request, options, callback);
    }
    createTensorboardRun(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    batchCreateTensorboardRuns(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.batchCreateTensorboardRuns(request, options, callback);
    }
    getTensorboardRun(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateTensorboardRun(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'tensorboard_run.name': (_a = request.tensorboardRun.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateTensorboardRun(request, options, callback);
    }
    batchCreateTensorboardTimeSeries(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.batchCreateTensorboardTimeSeries(request, options, callback);
    }
    createTensorboardTimeSeries(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.createTensorboardTimeSeries(request, options, callback);
    }
    getTensorboardTimeSeries(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.getTensorboardTimeSeries(request, options, callback);
    }
    updateTensorboardTimeSeries(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'tensorboard_time_series.name': (_a = request.tensorboardTimeSeries.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateTensorboardTimeSeries(request, options, callback);
    }
    batchReadTensorboardTimeSeriesData(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.batchReadTensorboardTimeSeriesData(request, options, callback);
    }
    readTensorboardTimeSeriesData(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                tensorboard_time_series: (_a = request.tensorboardTimeSeries) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.readTensorboardTimeSeriesData(request, options, callback);
    }
    writeTensorboardExperimentData(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                tensorboard_experiment: (_a = request.tensorboardExperiment) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.writeTensorboardExperimentData(request, options, callback);
    }
    writeTensorboardRunData(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                tensorboard_run: (_a = request.tensorboardRun) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.writeTensorboardRunData(request, options, callback);
    }
    /**
    ...
    readTensorboardBlobData(request, options) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                time_series: (_a = request.timeSeries) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.readTensorboardBlobData(request, options);
    }
    createTensorboard(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateTensorboardProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createTensorboard, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    updateTensorboard(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'tensorboard.name': (_a = request.tensorboard.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    async checkUpdateTensorboardProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateTensorboard, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deleteTensorboard(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteTensorboardProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteTensorboard, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deleteTensorboardExperiment(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.deleteTensorboardExperiment(request, options, callback);
    }
    /**
     ...
     */
    async checkDeleteTensorboardExperimentProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteTensorboardExperiment, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deleteTensorboardRun(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteTensorboardRunProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteTensorboardRun, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deleteTensorboardTimeSeries(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.deleteTensorboardTimeSeries(request, options, callback);
    }
    /**
     ...
     */
    async checkDeleteTensorboardTimeSeriesProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteTensorboardTimeSeries, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    listTensorboards(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listTensorboardsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listTensorboards.createStream(this.innerApiCalls.listTensorboards, request, callSettings);
    }
    /**
    ...
    listTensorboardsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTensorboards.asyncIterate(this.innerApiCalls['listTensorboards'], request, callSettings);
    }
    listTensorboardExperiments(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.listTensorboardExperiments(request, options, callback);
    }
    /**
     * Equivalent to `method.name.toCamelCase()`, but returns a NodeJS Stream object.
     * @param {Object} request
    ...
    listTensorboardExperimentsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTensorboardExperiments.createStream(this.innerApiCalls.listTensorboardExperiments, request, callSettings);
    }
    /**
    ...
    listTensorboardExperimentsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTensorboardExperiments.asyncIterate(this.innerApiCalls['listTensorboardExperiments'], request, callSettings);
    }
    listTensorboardRuns(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1.TensorboardRun|TensorboardRun} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed. Note that it can affect your quota.
    ...
    listTensorboardRunsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTensorboardRuns.createStream(this.innerApiCalls.listTensorboardRuns, request, callSettings);
    }
    /**
     ...
     *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
     *   When you iterate the returned iterable, each element will be an object representing
     *   {@link protos.google.cloud.aiplatform.v1.TensorboardRun|TensorboardRun}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/tensorboard_service.list_tensorboard_runs.js</caption>
     * region_tag:aiplatform_v1_generated_TensorboardService_ListTensorboardRuns_async
     */
    listTensorboardRunsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTensorboardRuns.asyncIterate(this.innerApiCalls['listTensorboardRuns'], request, callSettings);
    }
    listTensorboardTimeSeries(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.listTensorboardTimeSeries(request, options, callback);
    }
    /**
     * Equivalent to `method.name.toCamelCase()`, but returns a NodeJS Stream object.
     * @param {Object} request
     ...
     * @param {string} request.pageToken
     *   A page token, received from a previous
     *   {@link protos.google.cloud.aiplatform.v1.TensorboardService.ListTensorboardTimeSeries|TensorboardService.ListTensorboardTimeSeries}
     *   call. Provide this to retrieve the subsequent page.
     *
     *   When paginating, all other parameters provided to
     *   {@link protos.google.cloud.aiplatform.v1.TensorboardService.ListTensorboardTimeSeries|TensorboardService.ListTensorboardTimeSeries}
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1.TensorboardTimeSeries|TensorboardTimeSeries} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed. Note that it can affect your quota.
    ...
    listTensorboardTimeSeriesStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTensorboardTimeSeries.createStream(this.innerApiCalls.listTensorboardTimeSeries, request, callSettings);
    }
    /**
     ...
     *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
     *   When you iterate the returned iterable, each element will be an object representing
     *   {@link protos.google.cloud.aiplatform.v1.TensorboardTimeSeries|TensorboardTimeSeries}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/tensorboard_service.list_tensorboard_time_series.js</caption>
     * region_tag:aiplatform_v1_generated_TensorboardService_ListTensorboardTimeSeries_async
     */
    listTensorboardTimeSeriesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTensorboardTimeSeries.asyncIterate(this.innerApiCalls['listTensorboardTimeSeries'], request, callSettings);
    }
    exportTensorboardTimeSeriesData(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.exportTensorboardTimeSeriesData(request, options, callback);
    }
    /**
     * Equivalent to `method.name.toCamelCase()`, but returns a NodeJS Stream object.
     * @param {Object} request
     ...
     * @param {string} request.pageToken
     *   A page token, received from a previous
     *   {@link protos.google.cloud.aiplatform.v1.TensorboardService.ExportTensorboardTimeSeriesData|ExportTensorboardTimeSeriesData}
     *   call. Provide this to retrieve the subsequent page.
     *
     *   When paginating, all other parameters provided to
     *   {@link protos.google.cloud.aiplatform.v1.TensorboardService.ExportTensorboardTimeSeriesData|ExportTensorboardTimeSeriesData}
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1.TimeSeriesDataPoint|TimeSeriesDataPoint} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed. Note that it can affect your quota.
    ...
    exportTensorboardTimeSeriesDataStream(request, options) {
        ...
        const defaultCallSettings = this._defaults['exportTensorboardTimeSeriesData'];
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.exportTensorboardTimeSeriesData.createStream(this.innerApiCalls.exportTensorboardTimeSeriesData, request, callSettings);
    }
    /**
     ...
     *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
     *   When you iterate the returned iterable, each element will be an object representing
     *   {@link protos.google.cloud.aiplatform.v1.TimeSeriesDataPoint|TimeSeriesDataPoint}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/tensorboard_service.export_tensorboard_time_series_data.js</caption>
     * region_tag:aiplatform_v1_generated_TensorboardService_ExportTensorboardTimeSeriesData_async
     */
    exportTensorboardTimeSeriesDataAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.exportTensorboardTimeSeriesData.asyncIterate(this.innerApiCalls['exportTensorboardTimeSeriesData'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=tensorboard_service_client.js.map