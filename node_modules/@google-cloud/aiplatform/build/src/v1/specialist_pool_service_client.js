...
exports.SpecialistPoolServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/specialist_pool_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./specialist_pool_service_client_config.json");
...
class SpecialistPoolServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listSpecialistPools: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'specialistPools'),
        };
        ...
        const createSpecialistPoolResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.SpecialistPool');
        const createSpecialistPoolMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateSpecialistPoolOperationMetadata');
        const deleteSpecialistPoolResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteSpecialistPoolMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const updateSpecialistPoolResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.SpecialistPool');
        const updateSpecialistPoolMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdateSpecialistPoolOperationMetadata');
        this.descriptors.longrunning = {
            createSpecialistPool: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createSpecialistPoolResponse.decode.bind(createSpecialistPoolResponse), createSpecialistPoolMetadata.decode.bind(createSpecialistPoolMetadata)),
            deleteSpecialistPool: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteSpecialistPoolResponse.decode.bind(deleteSpecialistPoolResponse), deleteSpecialistPoolMetadata.decode.bind(deleteSpecialistPoolMetadata)),
            updateSpecialistPool: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateSpecialistPoolResponse.decode.bind(updateSpecialistPoolResponse), updateSpecialistPoolMetadata.decode.bind(updateSpecialistPoolMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.SpecialistPoolService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.specialistPoolServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.SpecialistPoolService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1
                    .SpecialistPoolService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of specialistPoolServiceStubMethods) {
            const callPromise = this.specialistPoolServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getSpecialistPool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    createSpecialistPool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     * region_tag:aiplatform_v1_generated_SpecialistPoolService_CreateSpecialistPool_async
     */
    async checkCreateSpecialistPoolProgress(name) {
    ...
    deleteSpecialistPool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     * region_tag:aiplatform_v1_generated_SpecialistPoolService_DeleteSpecialistPool_async
     */
    async checkDeleteSpecialistPoolProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    updateSpecialistPool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'specialist_pool.name': (_a = request.specialistPool.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     * region_tag:aiplatform_v1_generated_SpecialistPoolService_UpdateSpecialistPool_async
     */
    async checkUpdateSpecialistPoolProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listSpecialistPools(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     *   {@link protos.google.cloud.aiplatform.v1.ListSpecialistPoolsResponse.next_page_token|ListSpecialistPoolsResponse.next_page_token}
     *   of the previous
     *   {@link protos.google.cloud.aiplatform.v1.SpecialistPoolService.ListSpecialistPools|SpecialistPoolService.ListSpecialistPools}
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1.SpecialistPool|SpecialistPool} on 'data' event.
     ...
     *   for more details and examples.
     */
    listSpecialistPoolsStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.listSpecialistPools.createStream(this.innerApiCalls.listSpecialistPools, request, callSettings);
    }
    /**
     ...
     *   {@link protos.google.cloud.aiplatform.v1.SpecialistPool|SpecialistPool}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/specialist_pool_service.list_specialist_pools.js</caption>
     * region_tag:aiplatform_v1_generated_SpecialistPoolService_ListSpecialistPools_async
     */
    listSpecialistPoolsAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listSpecialistPools.asyncIterate(this.innerApiCalls['listSpecialistPools'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=specialist_pool_service_client.js.map