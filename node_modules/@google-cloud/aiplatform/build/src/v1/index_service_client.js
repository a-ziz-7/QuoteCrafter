...
exports.IndexServiceClient = void 0;
 ...
 */
const gapicConfig = require("./index_service_client_config.json");
...
class IndexServiceClient {
     ...
     *     const client = new IndexServiceClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        const createIndexResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.Index');
        const createIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateIndexOperationMetadata');
        const updateIndexResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.Index');
        const updateIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdateIndexOperationMetadata');
        const deleteIndexResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            ...
            updateIndex: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateIndexResponse.decode.bind(updateIndexResponse), updateIndexMetadata.decode.bind(updateIndexMetadata)),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.IndexService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.indexServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.IndexService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.IndexService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of indexServiceStubMethods) {
            const callPromise = this.indexServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    upsertDatapoints(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                index: (_a = request.index) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.upsertDatapoints(request, options, callback);
    }
    removeDatapoints(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateIndex(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'index.name': (_a = request.index.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     * region_tag:aiplatform_v1_generated_IndexService_UpdateIndex_async
     */
    async checkUpdateIndexProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     * region_tag:aiplatform_v1_generated_IndexService_DeleteIndex_async
     */
     ...
     *   {@link protos.google.cloud.aiplatform.v1.ListIndexesResponse.next_page_token|ListIndexesResponse.next_page_token}
     *   of the previous
     *   {@link protos.google.cloud.aiplatform.v1.IndexService.ListIndexes|IndexService.ListIndexes}
     *   call.
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1.Index|Index} on 'data' event.
     ...
     *   {@link protos.google.cloud.aiplatform.v1.Index|Index}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/index_service.list_indexes.js</caption>
     * region_tag:aiplatform_v1_generated_IndexService_ListIndexes_async
     */
...
//# sourceMappingURL=index_service_client.js.map