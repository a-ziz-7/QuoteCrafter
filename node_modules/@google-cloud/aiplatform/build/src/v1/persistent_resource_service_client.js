...
exports.PersistentResourceServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1/persistent_resource_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./persistent_resource_service_client_config.json");
...
class PersistentResourceServiceClient {
    /**
     * Construct an instance of PersistentResourceServiceClient.
     *
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listPersistentResources: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'persistentResources'),
        };
        ...
        const createPersistentResourceResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.PersistentResource');
        const createPersistentResourceMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreatePersistentResourceOperationMetadata');
        const deletePersistentResourceResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deletePersistentResourceMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const updatePersistentResourceResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.PersistentResource');
        const updatePersistentResourceMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdatePersistentResourceOperationMetadata');
        const rebootPersistentResourceResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.PersistentResource');
        const rebootPersistentResourceMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.RebootPersistentResourceOperationMetadata');
        this.descriptors.longrunning = {
            createPersistentResource: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createPersistentResourceResponse.decode.bind(createPersistentResourceResponse), createPersistentResourceMetadata.decode.bind(createPersistentResourceMetadata)),
            deletePersistentResource: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deletePersistentResourceResponse.decode.bind(deletePersistentResourceResponse), deletePersistentResourceMetadata.decode.bind(deletePersistentResourceMetadata)),
            updatePersistentResource: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updatePersistentResourceResponse.decode.bind(updatePersistentResourceResponse), updatePersistentResourceMetadata.decode.bind(updatePersistentResourceMetadata)),
            rebootPersistentResource: new this._gaxModule.LongrunningDescriptor(this.operationsClient, rebootPersistentResourceResponse.decode.bind(rebootPersistentResourceResponse), rebootPersistentResourceMetadata.decode.bind(rebootPersistentResourceMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.PersistentResourceService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.persistentResourceServiceStub) {
            return this.persistentResourceServiceStub;
        }
        // Put together the "service stub" for
        // google.cloud.aiplatform.v1.PersistentResourceService.
        this.persistentResourceServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.PersistentResourceService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1
                    .PersistentResourceService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of persistentResourceServiceStubMethods) {
            const callPromise = this.persistentResourceServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getPersistentResource(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    createPersistentResource(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.createPersistentResource(request, options, callback);
    }
    /**
     ...
     * @example <caption>include:samples/generated/v1/persistent_resource_service.create_persistent_resource.js</caption>
     * region_tag:aiplatform_v1_generated_PersistentResourceService_CreatePersistentResource_async
     */
    async checkCreatePersistentResourceProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createPersistentResource, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deletePersistentResource(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.deletePersistentResource(request, options, callback);
    }
    /**
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/persistent_resource_service.delete_persistent_resource.js</caption>
     * region_tag:aiplatform_v1_generated_PersistentResourceService_DeletePersistentResource_async
     */
    async checkDeletePersistentResourceProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deletePersistentResource, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    updatePersistentResource(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'persistent_resource.name': (_a = request.persistentResource.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updatePersistentResource(request, options, callback);
    }
    /**
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/persistent_resource_service.update_persistent_resource.js</caption>
     * region_tag:aiplatform_v1_generated_PersistentResourceService_UpdatePersistentResource_async
     */
    async checkUpdatePersistentResourceProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    rebootPersistentResource(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/persistent_resource_service.reboot_persistent_resource.js</caption>
     * region_tag:aiplatform_v1_generated_PersistentResourceService_RebootPersistentResource_async
     */
    async checkRebootPersistentResourceProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listPersistentResources(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.listPersistentResources(request, options, callback);
    }
    /**
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1.PersistentResource|PersistentResource} on 'data' event.
     ...
     *   for more details and examples.
     */
    listPersistentResourcesStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.listPersistentResources.createStream(this.innerApiCalls.listPersistentResources, request, callSettings);
    }
    /**
     * Equivalent to `listPersistentResources`, but returns an iterable object.
     *
     ...
     *   {@link protos.google.cloud.aiplatform.v1.PersistentResource|PersistentResource}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/persistent_resource_service.list_persistent_resources.js</caption>
     * region_tag:aiplatform_v1_generated_PersistentResourceService_ListPersistentResources_async
     */
    listPersistentResourcesAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listPersistentResources.asyncIterate(this.innerApiCalls['listPersistentResources'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=persistent_resource_service_client.js.map