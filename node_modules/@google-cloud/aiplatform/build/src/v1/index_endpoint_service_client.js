...
exports.IndexEndpointServiceClient = void 0;
 ...
 */
const gapicConfig = require("./index_endpoint_service_client_config.json");
...
class IndexEndpointServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listIndexEndpoints: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'indexEndpoints'),
        };
        ...
        const createIndexEndpointResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.IndexEndpoint');
        const createIndexEndpointMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateIndexEndpointOperationMetadata');
        const deleteIndexEndpointResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteIndexEndpointMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const deployIndexResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeployIndexResponse');
        const deployIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeployIndexOperationMetadata');
        const undeployIndexResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UndeployIndexResponse');
        const undeployIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UndeployIndexOperationMetadata');
        const mutateDeployedIndexResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.MutateDeployedIndexResponse');
        const mutateDeployedIndexMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.MutateDeployedIndexOperationMetadata');
        this.descriptors.longrunning = {
            createIndexEndpoint: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createIndexEndpointResponse.decode.bind(createIndexEndpointResponse), createIndexEndpointMetadata.decode.bind(createIndexEndpointMetadata)),
            deleteIndexEndpoint: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteIndexEndpointResponse.decode.bind(deleteIndexEndpointResponse), deleteIndexEndpointMetadata.decode.bind(deleteIndexEndpointMetadata)),
            deployIndex: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deployIndexResponse.decode.bind(deployIndexResponse), deployIndexMetadata.decode.bind(deployIndexMetadata)),
            undeployIndex: new this._gaxModule.LongrunningDescriptor(this.operationsClient, undeployIndexResponse.decode.bind(undeployIndexResponse), undeployIndexMetadata.decode.bind(undeployIndexMetadata)),
            mutateDeployedIndex: new this._gaxModule.LongrunningDescriptor(this.operationsClient, mutateDeployedIndexResponse.decode.bind(mutateDeployedIndexResponse), mutateDeployedIndexMetadata.decode.bind(mutateDeployedIndexMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.IndexEndpointService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.indexEndpointServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.IndexEndpointService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.IndexEndpointService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of indexEndpointServiceStubMethods) {
            const callPromise = this.indexEndpointServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getIndexEndpoint(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    updateIndexEndpoint(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'index_endpoint.name': (_a = request.indexEndpoint.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateIndexEndpoint(request, options, callback);
    }
    createIndexEndpoint(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateIndexEndpointProgress(name) {
    ...
    deleteIndexEndpoint(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteIndexEndpointProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deployIndex(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                index_endpoint: (_a = request.indexEndpoint) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     */
    async checkDeployIndexProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    undeployIndex(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkUndeployIndexProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    mutateDeployedIndex(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkMutateDeployedIndexProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listIndexEndpoints(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     *   for more details and examples.
     */
    listIndexEndpointsStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.listIndexEndpoints.createStream(this.innerApiCalls.listIndexEndpoints, request, callSettings);
    }
    /**
     ...
     */
    listIndexEndpointsAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listIndexEndpoints.asyncIterate(this.innerApiCalls['listIndexEndpoints'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=index_endpoint_service_client.js.map