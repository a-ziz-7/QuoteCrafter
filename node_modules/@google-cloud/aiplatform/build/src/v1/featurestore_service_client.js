...
exports.FeaturestoreServiceClient = void 0;
 ...
 */
const gapicConfig = require("./featurestore_service_client_config.json");
...
class FeaturestoreServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listFeaturestores: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'featurestores'),
            listEntityTypes: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'entityTypes'),
            listFeatures: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'features'),
            searchFeatures: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'features'),
        };
        ...
        const createFeaturestoreResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.Featurestore');
        const createFeaturestoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateFeaturestoreOperationMetadata');
        const updateFeaturestoreResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.Featurestore');
        const updateFeaturestoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdateFeaturestoreOperationMetadata');
        const deleteFeaturestoreResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteFeaturestoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const createEntityTypeResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.EntityType');
        const createEntityTypeMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateEntityTypeOperationMetadata');
        const deleteEntityTypeResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteEntityTypeMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        ...
        const importFeatureValuesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ImportFeatureValuesResponse');
        const importFeatureValuesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ImportFeatureValuesOperationMetadata');
        const batchReadFeatureValuesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.BatchReadFeatureValuesResponse');
        const batchReadFeatureValuesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.BatchReadFeatureValuesOperationMetadata');
        const exportFeatureValuesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ExportFeatureValuesResponse');
        const exportFeatureValuesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ExportFeatureValuesOperationMetadata');
        const deleteFeatureValuesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteFeatureValuesResponse');
        const deleteFeatureValuesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteFeatureValuesOperationMetadata');
        this.descriptors.longrunning = {
            createFeaturestore: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createFeaturestoreResponse.decode.bind(createFeaturestoreResponse), createFeaturestoreMetadata.decode.bind(createFeaturestoreMetadata)),
            updateFeaturestore: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateFeaturestoreResponse.decode.bind(updateFeaturestoreResponse), updateFeaturestoreMetadata.decode.bind(updateFeaturestoreMetadata)),
            deleteFeaturestore: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteFeaturestoreResponse.decode.bind(deleteFeaturestoreResponse), deleteFeaturestoreMetadata.decode.bind(deleteFeaturestoreMetadata)),
            createEntityType: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createEntityTypeResponse.decode.bind(createEntityTypeResponse), createEntityTypeMetadata.decode.bind(createEntityTypeMetadata)),
            deleteEntityType: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteEntityTypeResponse.decode.bind(deleteEntityTypeResponse), deleteEntityTypeMetadata.decode.bind(deleteEntityTypeMetadata)),
            ...
            importFeatureValues: new this._gaxModule.LongrunningDescriptor(this.operationsClient, importFeatureValuesResponse.decode.bind(importFeatureValuesResponse), importFeatureValuesMetadata.decode.bind(importFeatureValuesMetadata)),
            ...
            deleteFeatureValues: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteFeatureValuesResponse.decode.bind(deleteFeatureValuesResponse), deleteFeatureValuesMetadata.decode.bind(deleteFeatureValuesMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.FeaturestoreService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.featurestoreServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.FeaturestoreService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.FeaturestoreService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of featurestoreServiceStubMethods) {
            const callPromise = this.featurestoreServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getFeaturestore(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    getEntityType(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateEntityType(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'entity_type.name': (_a = request.entityType.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    createFeaturestore(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateFeaturestoreProgress(name) {
    ...
    updateFeaturestore(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'featurestore.name': (_a = request.featurestore.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     */
    async checkUpdateFeaturestoreProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deleteFeaturestore(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteFeaturestoreProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    createEntityType(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateEntityTypeProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deleteEntityType(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteEntityTypeProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    importFeatureValues(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                entity_type: (_a = request.entityType) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     */
    async checkImportFeatureValuesProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    batchReadFeatureValues(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                featurestore: (_a = request.featurestore) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.batchReadFeatureValues(request, options, callback);
    }
    /**
     ...
     */
    async checkBatchReadFeatureValuesProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    exportFeatureValues(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkExportFeatureValuesProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deleteFeatureValues(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteFeatureValuesProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listFeaturestores(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listFeaturestoresStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listFeaturestores.createStream(this.innerApiCalls.listFeaturestores, request, callSettings);
    }
    /**
    ...
    listFeaturestoresAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listFeaturestores.asyncIterate(this.innerApiCalls['listFeaturestores'], request, callSettings);
    }
    listEntityTypes(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listEntityTypesStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listEntityTypes.createStream(this.innerApiCalls.listEntityTypes, request, callSettings);
    }
    /**
    ...
    listEntityTypesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listEntityTypes.asyncIterate(this.innerApiCalls['listEntityTypes'], request, callSettings);
    }
    ...
    searchFeatures(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    searchFeaturesStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchFeatures.createStream(this.innerApiCalls.searchFeatures, request, callSettings);
    }
    /**
    ...
    searchFeaturesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchFeatures.asyncIterate(this.innerApiCalls['searchFeatures'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=featurestore_service_client.js.map