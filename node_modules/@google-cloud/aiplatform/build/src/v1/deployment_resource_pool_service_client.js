...
exports.DeploymentResourcePoolServiceClient = void 0;
 ...
 */
const gapicConfig = require("./deployment_resource_pool_service_client_config.json");
...
class DeploymentResourcePoolServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listDeploymentResourcePools: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'deploymentResourcePools'),
            queryDeployedModels: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'deployedModels'),
        };
        ...
        const createDeploymentResourcePoolResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeploymentResourcePool');
        const createDeploymentResourcePoolMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateDeploymentResourcePoolOperationMetadata');
        const updateDeploymentResourcePoolResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeploymentResourcePool');
        const updateDeploymentResourcePoolMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdateDeploymentResourcePoolOperationMetadata');
        const deleteDeploymentResourcePoolResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteDeploymentResourcePoolMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            createDeploymentResourcePool: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createDeploymentResourcePoolResponse.decode.bind(createDeploymentResourcePoolResponse), createDeploymentResourcePoolMetadata.decode.bind(createDeploymentResourcePoolMetadata)),
            updateDeploymentResourcePool: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateDeploymentResourcePoolResponse.decode.bind(updateDeploymentResourcePoolResponse), updateDeploymentResourcePoolMetadata.decode.bind(updateDeploymentResourcePoolMetadata)),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.DeploymentResourcePoolService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.deploymentResourcePoolServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.DeploymentResourcePoolService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1
                    .DeploymentResourcePoolService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of deploymentResourcePoolServiceStubMethods) {
            const callPromise = this.deploymentResourcePoolServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getDeploymentResourcePool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.getDeploymentResourcePool(request, options, callback);
    }
    createDeploymentResourcePool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.createDeploymentResourcePool(request, options, callback);
    }
    /**
     ...
     */
    async checkCreateDeploymentResourcePoolProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createDeploymentResourcePool, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    updateDeploymentResourcePool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'deployment_resource_pool.name': (_a = request.deploymentResourcePool.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateDeploymentResourcePool(request, options, callback);
    }
    /**
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/deployment_resource_pool_service.update_deployment_resource_pool.js</caption>
     * region_tag:aiplatform_v1_generated_DeploymentResourcePoolService_UpdateDeploymentResourcePool_async
     */
    async checkUpdateDeploymentResourcePoolProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateDeploymentResourcePool, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deleteDeploymentResourcePool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.deleteDeploymentResourcePool(request, options, callback);
    }
    /**
     ...
     */
    async checkDeleteDeploymentResourcePoolProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteDeploymentResourcePool, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    listDeploymentResourcePools(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.listDeploymentResourcePools(request, options, callback);
    }
    /**
     ...
     *   for more details and examples.
     */
    listDeploymentResourcePoolsStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.listDeploymentResourcePools.createStream(this.innerApiCalls.listDeploymentResourcePools, request, callSettings);
    }
    /**
     ...
     */
    listDeploymentResourcePoolsAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listDeploymentResourcePools.asyncIterate(this.innerApiCalls['listDeploymentResourcePools'], request, callSettings);
    }
    queryDeployedModels(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                deployment_resource_pool: (_a = request.deploymentResourcePool) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     *   for more details and examples.
     */
    queryDeployedModelsStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.queryDeployedModels.createStream(this.innerApiCalls.queryDeployedModels, request, callSettings);
    }
    /**
     ...
     */
    queryDeployedModelsAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.queryDeployedModels.asyncIterate(this.innerApiCalls['queryDeployedModels'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=deployment_resource_pool_service_client.js.map