...
class MetadataServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createMetadataStoreResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.MetadataStore');
        const createMetadataStoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateMetadataStoreOperationMetadata');
        const deleteMetadataStoreResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteMetadataStoreMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteMetadataStoreOperationMetadata');
        const deleteArtifactResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteArtifactMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const purgeArtifactsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.PurgeArtifactsResponse');
        const purgeArtifactsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.PurgeArtifactsMetadata');
        const deleteContextResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteContextMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const purgeContextsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.PurgeContextsResponse');
        const purgeContextsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.PurgeContextsMetadata');
        const deleteExecutionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteExecutionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const purgeExecutionsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.PurgeExecutionsResponse');
        const purgeExecutionsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.PurgeExecutionsMetadata');
        this.descriptors.longrunning = {
            ...
            deleteArtifact: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteArtifactResponse.decode.bind(deleteArtifactResponse), deleteArtifactMetadata.decode.bind(deleteArtifactMetadata)),
            purgeArtifacts: new this._gaxModule.LongrunningDescriptor(this.operationsClient, purgeArtifactsResponse.decode.bind(purgeArtifactsResponse), purgeArtifactsMetadata.decode.bind(purgeArtifactsMetadata)),
            ...
            purgeContexts: new this._gaxModule.LongrunningDescriptor(this.operationsClient, purgeContextsResponse.decode.bind(purgeContextsResponse), purgeContextsMetadata.decode.bind(purgeContextsMetadata)),
            deleteExecution: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteExecutionResponse.decode.bind(deleteExecutionResponse), deleteExecutionMetadata.decode.bind(deleteExecutionMetadata)),
            purgeExecutions: new this._gaxModule.LongrunningDescriptor(this.operationsClient, purgeExecutionsResponse.decode.bind(purgeExecutionsResponse), purgeExecutionsMetadata.decode.bind(purgeExecutionsMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.MetadataService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.metadataServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.MetadataService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.MetadataService, this._opts, this._providedCustomServicePath);
    ...
    updateArtifact(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'artifact.name': (_a = request.artifact.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    updateContext(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'context.name': (_a = request.context.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    addContextArtifactsAndExecutions(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                context: (_a = request.context) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    removeContextChildren(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateExecution(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'execution.name': (_a = request.execution.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    addExecutionEvents(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                execution: (_a = request.execution) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    queryArtifactLineageSubgraph(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                artifact: (_a = request.artifact) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    deleteArtifact(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteArtifactProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    purgeArtifacts(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkPurgeArtifactsProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    purgeContexts(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkPurgeContextsProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    purgeExecutions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkPurgeExecutionsProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
