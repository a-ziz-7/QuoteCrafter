...
exports.PipelineServiceClient = void 0;
 ...
 */
const gapicConfig = require("./pipeline_service_client_config.json");
...
class PipelineServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listTrainingPipelines: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'trainingPipelines'),
            listPipelineJobs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'pipelineJobs'),
        };
        ...
        const deleteTrainingPipelineResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteTrainingPipelineMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const deletePipelineJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deletePipelineJobMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const batchDeletePipelineJobsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.BatchDeletePipelineJobsResponse');
        const batchDeletePipelineJobsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const batchCancelPipelineJobsResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.BatchCancelPipelineJobsResponse');
        const batchCancelPipelineJobsMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.BatchCancelPipelineJobsOperationMetadata');
        this.descriptors.longrunning = {
            deleteTrainingPipeline: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteTrainingPipelineResponse.decode.bind(deleteTrainingPipelineResponse), deleteTrainingPipelineMetadata.decode.bind(deleteTrainingPipelineMetadata)),
            deletePipelineJob: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deletePipelineJobResponse.decode.bind(deletePipelineJobResponse), deletePipelineJobMetadata.decode.bind(deletePipelineJobMetadata)),
            batchDeletePipelineJobs: new this._gaxModule.LongrunningDescriptor(this.operationsClient, batchDeletePipelineJobsResponse.decode.bind(batchDeletePipelineJobsResponse), batchDeletePipelineJobsMetadata.decode.bind(batchDeletePipelineJobsMetadata)),
            batchCancelPipelineJobs: new this._gaxModule.LongrunningDescriptor(this.operationsClient, batchCancelPipelineJobsResponse.decode.bind(batchCancelPipelineJobsResponse), batchCancelPipelineJobsMetadata.decode.bind(batchCancelPipelineJobsMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.PipelineService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.pipelineServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.PipelineService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.PipelineService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of pipelineServiceStubMethods) {
            const callPromise = this.pipelineServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createTrainingPipeline(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    getTrainingPipeline(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    cancelTrainingPipeline(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createPipelineJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getPipelineJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    cancelPipelineJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    deleteTrainingPipeline(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteTrainingPipelineProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteTrainingPipeline, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deletePipelineJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeletePipelineJobProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deletePipelineJob, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    batchDeletePipelineJobs(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.batchDeletePipelineJobs(request, options, callback);
    }
    /**
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/pipeline_service.batch_delete_pipeline_jobs.js</caption>
     * region_tag:aiplatform_v1_generated_PipelineService_BatchDeletePipelineJobs_async
     */
    async checkBatchDeletePipelineJobsProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.batchDeletePipelineJobs, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    batchCancelPipelineJobs(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.batchCancelPipelineJobs(request, options, callback);
    }
    /**
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#long-running-operations | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1/pipeline_service.batch_cancel_pipeline_jobs.js</caption>
     * region_tag:aiplatform_v1_generated_PipelineService_BatchCancelPipelineJobs_async
     */
    async checkBatchCancelPipelineJobsProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.batchCancelPipelineJobs, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    listTrainingPipelines(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listTrainingPipelinesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listTrainingPipelines.createStream(this.innerApiCalls.listTrainingPipelines, request, callSettings);
    }
    /**
    ...
    listTrainingPipelinesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTrainingPipelines.asyncIterate(this.innerApiCalls['listTrainingPipelines'], request, callSettings);
    }
    listPipelineJobs(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listPipelineJobsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listPipelineJobs.createStream(this.innerApiCalls.listPipelineJobs, request, callSettings);
    }
    /**
    ...
    listPipelineJobsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listPipelineJobs.asyncIterate(this.innerApiCalls['listPipelineJobs'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=pipeline_service_client.js.map