 ...
 */
const gapicConfig = require("./dataset_service_client_config.json");
...
class DatasetServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            ...
            listDatasetVersions: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'datasetVersions'),
            listDataItems: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'dataItems'),
            searchDataItems: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'dataItemViews'),
            listSavedQueries: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'savedQueries'),
            listAnnotations: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'annotations'),
        };
        ...
        const createDatasetResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.Dataset');
        const createDatasetMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateDatasetOperationMetadata');
        const deleteDatasetResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteDatasetMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const importDataResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ImportDataResponse');
        const importDataMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ImportDataOperationMetadata');
        const exportDataResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ExportDataResponse');
        const exportDataMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ExportDataOperationMetadata');
        const createDatasetVersionResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DatasetVersion');
        const createDatasetVersionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CreateDatasetVersionOperationMetadata');
        const deleteDatasetVersionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteDatasetVersionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const restoreDatasetVersionResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DatasetVersion');
        const restoreDatasetVersionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.RestoreDatasetVersionOperationMetadata');
        const deleteSavedQueryResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteSavedQueryMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            ...
            createDatasetVersion: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createDatasetVersionResponse.decode.bind(createDatasetVersionResponse), createDatasetVersionMetadata.decode.bind(createDatasetVersionMetadata)),
            deleteDatasetVersion: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteDatasetVersionResponse.decode.bind(deleteDatasetVersionResponse), deleteDatasetVersionMetadata.decode.bind(deleteDatasetVersionMetadata)),
            restoreDatasetVersion: new this._gaxModule.LongrunningDescriptor(this.operationsClient, restoreDatasetVersionResponse.decode.bind(restoreDatasetVersionResponse), restoreDatasetVersionMetadata.decode.bind(restoreDatasetVersionMetadata)),
            deleteSavedQuery: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteSavedQueryResponse.decode.bind(deleteSavedQueryResponse), deleteSavedQueryMetadata.decode.bind(deleteSavedQueryMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.DatasetService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.datasetServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.DatasetService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.DatasetService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of datasetServiceStubMethods) {
            const callPromise = this.datasetServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    updateDataset(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'dataset.name': (_a = request.dataset.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateDataset(request, options, callback);
    }
    updateDatasetVersion(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'dataset_version.name': (_a = request.datasetVersion.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateDatasetVersion(request, options, callback);
    }
    getDatasetVersion(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createDatasetVersion(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateDatasetVersionProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createDatasetVersion, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deleteDatasetVersion(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteDatasetVersionProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteDatasetVersion, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    restoreDatasetVersion(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkRestoreDatasetVersionProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.restoreDatasetVersion, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deleteSavedQuery(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteSavedQueryProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteSavedQuery, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    ...
    listDatasetVersions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listDatasetVersionsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listDatasetVersions.createStream(this.innerApiCalls.listDatasetVersions, request, callSettings);
    }
    /**
    ...
    listDatasetVersionsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listDatasetVersions.asyncIterate(this.innerApiCalls['listDatasetVersions'], request, callSettings);
    }
    ...
    searchDataItems(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                dataset: (_a = request.dataset) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    searchDataItemsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchDataItems.createStream(this.innerApiCalls.searchDataItems, request, callSettings);
    }
    /**
    ...
    searchDataItemsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchDataItems.asyncIterate(this.innerApiCalls['searchDataItems'], request, callSettings);
    }
    listSavedQueries(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listSavedQueriesStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listSavedQueries.createStream(this.innerApiCalls.listSavedQueries, request, callSettings);
    }
    /**
    ...
    listSavedQueriesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listSavedQueries.asyncIterate(this.innerApiCalls['listSavedQueries'], request, callSettings);
    }
    listAnnotations(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listAnnotationsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listAnnotations.createStream(this.innerApiCalls.listAnnotations, request, callSettings);
    }
    /**
    ...
    listAnnotationsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listAnnotations.asyncIterate(this.innerApiCalls['listAnnotations'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=dataset_service_client.js.map