...
class ModelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            ...
            listModelVersions: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'models'),
            listModelEvaluations: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'modelEvaluations'),
            listModelEvaluationSlices: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'modelEvaluationSlices'),
        };
        ...
        const uploadModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UploadModelResponse');
        const uploadModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UploadModelOperationMetadata');
        const updateExplanationDatasetResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdateExplanationDatasetResponse');
        const updateExplanationDatasetMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.UpdateExplanationDatasetOperationMetadata');
        const deleteModelResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const deleteModelVersionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteModelVersionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.DeleteOperationMetadata');
        const exportModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ExportModelResponse');
        const exportModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.ExportModelOperationMetadata');
        const copyModelResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CopyModelResponse');
        const copyModelMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.CopyModelOperationMetadata');
        this.descriptors.longrunning = {
            uploadModel: new this._gaxModule.LongrunningDescriptor(this.operationsClient, uploadModelResponse.decode.bind(uploadModelResponse), uploadModelMetadata.decode.bind(uploadModelMetadata)),
            updateExplanationDataset: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateExplanationDatasetResponse.decode.bind(updateExplanationDatasetResponse), updateExplanationDatasetMetadata.decode.bind(updateExplanationDatasetMetadata)),
            ...
            deleteModelVersion: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteModelVersionResponse.decode.bind(deleteModelVersionResponse), deleteModelVersionMetadata.decode.bind(deleteModelVersionMetadata)),
            ...
            copyModel: new this._gaxModule.LongrunningDescriptor(this.operationsClient, copyModelResponse.decode.bind(copyModelResponse), copyModelMetadata.decode.bind(copyModelMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.ModelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.modelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.ModelService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.ModelService, this._opts, this._providedCustomServicePath);
    ...
    updateModel(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'model.name': (_a = request.model.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateModel(request, options, callback);
    }
    mergeVersionAliases(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    importModelEvaluation(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    batchImportModelEvaluationSlices(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.batchImportModelEvaluationSlices(request, options, callback);
    }
    batchImportEvaluatedAnnotations(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.batchImportEvaluatedAnnotations(request, options, callback);
    }
    ...
    getModelEvaluationSlice(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    uploadModel(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkUploadModelProgress(name) {
    ...
    updateExplanationDataset(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.updateExplanationDataset(request, options, callback);
    }
    /**
     ...
     */
    async checkUpdateExplanationDatasetProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deleteModelVersion(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteModelVersionProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    copyModel(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCopyModelProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listModelVersions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listModelVersionsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listModelVersions.createStream(this.innerApiCalls.listModelVersions, request, callSettings);
    }
    /**
    ...
    listModelVersionsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listModelVersions.asyncIterate(this.innerApiCalls['listModelVersions'], request, callSettings);
    }
    ...
    listModelEvaluationSlices(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listModelEvaluationSlicesStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listModelEvaluationSlices.createStream(this.innerApiCalls.listModelEvaluationSlices, request, callSettings);
    }
    /**
    ...
    listModelEvaluationSlicesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listModelEvaluationSlices.asyncIterate(this.innerApiCalls['listModelEvaluationSlices'], request, callSettings);
    }
    /**
