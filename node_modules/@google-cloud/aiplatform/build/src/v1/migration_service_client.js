...
exports.MigrationServiceClient = void 0;
 ...
 */
const gapicConfig = require("./migration_service_client_config.json");
...
class MigrationServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            searchMigratableResources: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'migratableResources'),
        };
        ...
        const batchMigrateResourcesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.BatchMigrateResourcesResponse');
        const batchMigrateResourcesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.BatchMigrateResourcesOperationMetadata');
        this.descriptors.longrunning = {
            batchMigrateResources: new this._gaxModule.LongrunningDescriptor(this.operationsClient, batchMigrateResourcesResponse.decode.bind(batchMigrateResourcesResponse), batchMigrateResourcesMetadata.decode.bind(batchMigrateResourcesMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1.MigrationService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.migrationServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1.MigrationService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1.MigrationService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of migrationServiceStubMethods) {
            const callPromise = this.migrationServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    batchMigrateResources(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
     ...
     */
    async checkBatchMigrateResourcesProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.batchMigrateResources, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    searchMigratableResources(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     *       of {@link protos.google.cloud.aiplatform.v1.MigratableResource|MigratableResource}:
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.aiplatform.v1.MigratableResource|MigratableResource} on 'data' event.
     ...
     *   for more details and examples.
     */
    searchMigratableResourcesStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.searchMigratableResources.createStream(this.innerApiCalls.searchMigratableResources, request, callSettings);
    }
    /**
     ...
     *   {@link protos.google.cloud.aiplatform.v1.MigratableResource|MigratableResource}. The API will be called under the hood as needed, once per the page,
     ...
     */
    searchMigratableResourcesAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchMigratableResources.asyncIterate(this.innerApiCalls['searchMigratableResources'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=migration_service_client.js.map